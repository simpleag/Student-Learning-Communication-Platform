...
public class RedisUtils {
    ...
    private static String AUTH = "Aa111111";          // 密码(原始默认是没有密码)
    //    @Value("${spring.redis.password.max-active}")
    private static int MAX_ACTIVE = 8;       // 最大连接数
    //    @Value("${spring.redis.pool.max-idle}")
    private static int MAX_IDLE = 8;          // 设置最大空闲数
    ...
    static {
        ...
        pool = new JedisPool(config, IP, PORT, TIMEOUT, AUTH, 2);
    }
